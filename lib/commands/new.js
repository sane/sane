...
module.exports = function newProject(name, options) {
  ...
  return regeneratorRuntime.async(function newProject$(context$1$0) {
    ...
    case 0:
      ...
      context$1$0.next = 19;
      return spawnPromise('fig', ['run', 'server', 'sails', 'new', '.'], { stdio: 'inherit', env: process.env });
    case 19:
      context$1$0.next = 23;
      break;
    case 21:
      context$1$0.next = 23;
      return spawnPromise('sails', ['new', '.'], { stdio: 'inherit', env: process.env });
    case 23:
    ...
    case 41:
      ...
      context$1$0.next = 46;
      return spawnPromise('ember', ['new', 'client'], { stdio: 'inherit', env: process.env });
    case 46:
