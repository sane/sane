        ...
        success: function success(actions) {
          ...
          return regeneratorRuntime.async(function success$(context$3$0) {
            while (1) switch (context$3$0.prev = context$3$0.next) {
              ...
              case 21:
                context$3$0.prev = 21;
                context$3$0.t27 = context$3$0['catch'](16);

                console.log(chalk.red('Error with ember install.') + chalk.yellow(' Carrying on installation.'));
                log.verbose(chalk.red(context$3$0.t27.message));
                if (context$3$0.t27.stack) {
                  log.verbose(context$3$0.t27.stack);
                }
                addonErrors.push(context$3$0.t27);
              ...
              case 47:
                context$3$0.prev = 47;
                context$3$0.t28 = context$3$0['catch'](42);

                console.log(chalk.red('Error with ember generate.') + chalk.yellow(' Carrying on installation.'));
                log.verbose(chalk.red(context$3$0.t28.message));
                if (context$3$0.t28.stack) {
                  log.verbose(context$3$0.t28.stack);
                }
                addonErrors.push(context$3$0.t28);
        ...
        success: function success(actions) {
          ...
          return regeneratorRuntime.async(function success$(context$3$0) {
            while (1) switch (context$3$0.prev = context$3$0.next) {
              ...
              case 27:
                context$3$0.prev = 27;
                context$3$0.t29 = context$3$0['catch'](22);

                addonErrors.push(context$3$0.t29);
                console.log(chalk.red('Error with server npm install.') + chalk.yellow(' Carrying on installation.'));
                log.verbose(chalk.red(context$3$0.t29.message));
                if (context$3$0.t29.stack) {
                  log.verbose(context$3$0.t29.stack);
                }
